-- Must be applied to a migration manually as drizzle doesn't currently
-- support functions and triggers - https://github.com/drizzle-team/drizzle-orm/issues/843
-- drop on_auth_user_logged_in trigger if already exists
